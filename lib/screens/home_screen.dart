    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Лента
          Expanded(
            child: p.orders.isEmpty && !p.loading
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          _selectedCity != null
                              ? 'Нет заказов в городе $_selectedCity'
                              : 'Нет объявлений',
            ...
            return ListView.builder(
              ...
              itemBuilder: (_, i) {
                ...
                return ListTile(
                  ...
                  title:
                      Text(d['lastMessage'] as String? ?? 'Новый чат'),
                  onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) =>
                              ChatScreen(chatId: s.data!.docs[i].id))),
                );
              },
            );
          },
